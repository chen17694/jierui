<template>
  <div>
    ...
    <tables ref="tables" :total="this.total" v-model="tableData" :columns="columns" :on-change="pageChange" :on-page-size-change="pageSizeChange" @on-edit="onEdit" @on-selection-change="onSelectionChange"></tables>
    <Modal
      v-model="edit"
      @on-ok="saveEdit"
      title="编辑日报">
